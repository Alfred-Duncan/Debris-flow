...
def run(case,prefix):
 ...
 return a,ar
c3,a3=run('C3_published_source_only','C3_published');e4,a4=run('E4_published','E4_published');times=[90,180,300,420,600,900];co=[]
for t in times:
...
with open(res/'PUBLISHED_C3_E4_COMPARISON.csv','w',newline='')as f:w=csv.DictWriter(f,co[0].keys());w.writeheader();w.writerows(co)
