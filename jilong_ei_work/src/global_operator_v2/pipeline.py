...
@dataclass
class PipelineState:
 pipeline_version:str;config_hash:str;architecture:dict|None=None;current_stage:str='PRECHECK';stage_step:int=0;global_step:int=0;stage_updates_total:int=0;best_val_score:float|None=None;best_checkpoint_path:str|None=None;completed_stages:list[str]=field(default_factory=list);final_holdout_generated:bool=False;final_holdout_unsealed:bool=False;legacy_test_done:bool=False;final_holdout_done:bool=False;h0_done:bool=False;runtime_done:bool=False;final_report_done:bool=False
...
def checkpoint_agreement(state,ck):
 fields=('stage_name','stage_step','global_step','config_hash','architecture')
